...
# and click it
driver.find_element_by_xpath('//*[@id="published-grid"]/div/div[1]/div[2]/div[1]/div/div/ul/li[4]/div/div[2]/button/span[1]').click()
time.sleep(1)

# find the sport on the menu using the text inside <a> tags
# and click it
driver.find_element_by_link_text('U.S. Tennis Association').click()
time.sleep(2)
...
csvfile = open('tennis.csv', 'w', newline='', encoding='utf-8')
